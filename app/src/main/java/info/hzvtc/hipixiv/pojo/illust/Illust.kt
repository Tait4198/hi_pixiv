...
data class Illust(
        ...
        @SerializedName("tags") @Expose val tags : List<Tag> = ArrayList(),
        @SerializedName("tools") @Expose val tools : List<String> = ArrayList(),
        ...
        @SerializedName("meta_pages") @Expose val metaPages : List<MetaImageUrls> = ArrayList(),
